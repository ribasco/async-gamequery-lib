...
public class GetMostPopularTags extends SteamStoreServiceRequest {
     ...
     *         a int
     */
    public GetMostPopularTags(int apiVersion, String language) {
        super("GetMostPopularTags", apiVersion);
